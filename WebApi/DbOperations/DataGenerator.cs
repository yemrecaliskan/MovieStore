    ...
    public class DataGenerator
    {
        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new MovieStoreDbContext(serviceProvider.GetRequiredService<DbContextOptions<MovieStoreDbContext>>()))
            {
                ...
                {
                    new Customer { firstName = "Yunus Emre", lastName = "Çalışkan", Email = "yemre@gmail.com", Password = "12345" },
                    new Customer { firstName = "Aslıhan", lastName = "Atıcı", Email = "aslihan@gmail.com", Password = "12345" },
                    new Customer { firstName = "Ahmet", lastName = "Çinici", Email = "ahmet@gmail.com", Password = "12345" }
                };
